...
const (
	...
	TaskService_ListTasksByChat_FullMethodName    = "/task.v1.TaskService/ListTasksByChat"
)
...
func (c *taskServiceClient) ListTasksByChat(ctx context.Context, in *ListTasksByChatRequest, opts ...grpc.CallOption) (*ListTasksByChatResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListTasksByChatResponse)
	err := c.cc.Invoke(ctx, TaskService_ListTasksByChat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTaskServiceServer) ListTasksByChat(context.Context, *ListTasksByChatRequest) (*ListTasksByChatResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListTasksByChat not implemented")
}
...
func _TaskService_ListTasksByChat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListTasksByChatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskServiceServer).ListTasksByChat(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskService_ListTasksByChat_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).ListTasksByChat(ctx, req.(*ListTasksByChatRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListTasksByChat",
			Handler:    _TaskService_ListTasksByChat_Handler,
		},
	},
